...
namespace Tiger.Hal
{
    ...
    public static partial class LinkData
    {
        ...
        [NotNull]
        public static ILinkData Route([NotNull] string routeName, [CanBeNull] object routeValues = null) =>
        ...
        [NotNull]
        public static ILinkData Template([NotNull] UriTemplate template) => new Templated(template);
        ...
        /// <exception cref="ArgumentNullException"><paramref name="template"/> is <see langword="null"/>.</exception>
        [NotNull]
        public static ILinkData Template([NotNull] string template) => new Templated(template);
        ...
        [NotNull]
        public static ILinkData Const([NotNull] Uri href) => new Constant(href);
        ...
        [NotNull]
        public static ILinkData Const([NotNull] string href) => new Constant(href);
    }
}
